...
This project is of a basic website that allows to checkout today's task from a list.

**[To do list]** is a basic website that allows users to check today's to do tasks from a list
...
2. - [ ] Run `https://github.com/ameerhamzakhalid/todo-list.git`
3. - [ ] cd todo-list
4. - [ ] Open in the IDE
